...
>
> 返回 [项目总览](../README.md) | 相关文档：[Skill 开发指南](./5_OpenClaw_Skills.md) | [踩坑记录](./2_OpenClaw_Pitfalls_and_Practices.md#踩坑记录)
...
>
> 相关文档：[Skill 开发指南](./5_OpenClaw_Skills.md) | [踩坑记录：坑 12（插件原生工具）](./2_OpenClaw_Pitfalls_and_Practices.md#坑-12skill-上下文依赖--自定义插件原生-function-calling)

---

> **文档最近修订**：2026-03-23（踩坑交叉链接改指向 [doc2](./2_OpenClaw_Pitfalls_and_Practices.md)）
