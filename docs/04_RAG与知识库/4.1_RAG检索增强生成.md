<div style="text-align: center; font-size: 2rem; font-weight: 700; margin-bottom: 0.5rem;"><strong>RAG 检索增强生成</strong></div>
...
# 9. RAG（Retrieval-Augmented Generation）流程概述
...
# 10. 知识库构建阶段（Offline Preparation）
...
### 描述一个 RAG 系统的端到端流程，并说明每个步骤的潜在瓶颈。
...
### 在 RAG 中，如何实现多跳检索（multi-hop retrieval）？
...
# 18. 📎 参考资料：RAG问答系统设计与实现


# 19. RAG 问答系统 - 基于 PDF 的智能问答工具
