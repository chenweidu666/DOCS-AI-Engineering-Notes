...
#### 2.3.2.3. 步骤 3：安装 PyTorch（根据 CUDA 版本选择）
...
#### 2.3.4.3. 问题 3：llm-compressor 找不到
...
#### 2.8.3.1. Q1: llm-compressor 和 GPTQ、AWQ 有什么区别？
...
#### 2.8.3.6. Q6: 量化过程中如何选择 per-tensor 还是 per-channel？
...
#### 2.8.3.7. Q7: 量化后的模型在不同硬件上的性能差异大吗？
...
#### 2.8.3.8. Q8: 如何处理量化后的模型在不同 batch size 下的性能？
...
#### 2.10.1.1. Q11: 量化过程中的 Round-to-Nearest (RTN) 和 GPTQ 的区别是什么？
...
#### 2.10.1.2. Q12: 量化中的对称量化和非对称量化如何选择？
...
#### 2.10.1.3. Q13: 量化中的 Calibration 过程具体是怎么做的？
...
#### 2.10.1.4. Q14: 量化误差是如何累积的？如何减少误差累积？
...
### 2.10.2. 5 项目经验描述模板（STAR 法则）

#### 2.10.2.1. 模板 1：量化项目整体描述
...
#### 2.10.3.1. Q15: 如何设计一个支持多种量化方案的量化服务？
