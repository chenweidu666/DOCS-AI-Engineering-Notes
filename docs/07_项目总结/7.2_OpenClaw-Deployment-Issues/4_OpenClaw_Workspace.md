...
# 1. OpenClaw 自定义 Workspace：让 AI 有灵魂
...
| 别名 | IP | 设备 | 用途 |
|------|-----|------|------|
| nas  | 192.168.31.10  | 绿联 DH4300+ NAS       | OpenClaw 宿主机 + 存储 |
```
...
> **文档最近修订**：2026-03-23（示例环境中 NAS 机型名称与全文统一为 DH4300+）
