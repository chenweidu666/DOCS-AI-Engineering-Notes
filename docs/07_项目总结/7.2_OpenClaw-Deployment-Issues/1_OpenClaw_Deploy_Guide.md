...
| **部署方式** | 网关可 `npm install -g` 直装，**不强制** Docker；本文实战为加固选用 Docker 隔离 | 多数需要 Docker Compose |
...
> - [踩坑记录与实践](./2_OpenClaw_Pitfalls_and_Practices.md#踩坑记录) — 17 则案例与最佳实践
> - [安全与时间线复盘](./7_OpenClaw_Security_and_Retrospective.md) — 部署里程碑、功能总览、Token 评估
> - 返回 [项目总览](../README.md)

---

> **文档最近修订**：2026-03-23（导航补充 doc2 / doc7；选型表「部署方式」与 Docker 表述对齐）
