...
## 1.5. 接入多个 MCP 服务（量化 / 数据类 Agent 示例）
...
## 1.8. 附录：MCP 技术介绍与实践（扩展阅读）

## 1.9. MCP（Model Context Protocol）技术介绍
...
## 1.13. MCP vs Function Calling（面试高频对比）
...
### 1.14.1. 1 场景一：代码智能体（Cursor / Claude Code / Cline）
...
### 1.14.2. 2 场景二：本地知识管理（Obsidian / Logseq / PDF）
...
### 1.14.3. 3 场景三：企业系统集成（Jira / Confluence / 飞书）
