...
- **拉取上游镜像**：`fetch_github_docs.py` 同步 **CineMaker-AI-Platform** 与 **OpenClaw-Deployment-Issues** 的 Markdown 到 **`../归档/from_3_技术文档/projects/`**。Docsify 第七章正文在 **`docs/07_项目总结/7.1_CineMaker/`** 与 **`docs/07_项目总结/7.2_OpenClaw-Deployment-Issues/`**，需与归档或上游保持一致时自行对齐。
